...
public class VaccinePanel extends JPanel {
	...
	/** The flu radio button */
	private final JRadioButton fluCheck;
	
	/** The tetanus radio button */
	private final JRadioButton tetanusCheck;
	
	/** The mmr radio button */
	private final JRadioButton mmrCheck;
	
	/** The hepatitis radio button */
	private final JRadioButton hepCheck;
	
	/** The steroid radio button */
	private final JRadioButton steriodCheck;
	...
	public VaccinePanel() {
		...
		final JLabel lblAddVaccine = new JLabel("Add Vaccine\r\n");
