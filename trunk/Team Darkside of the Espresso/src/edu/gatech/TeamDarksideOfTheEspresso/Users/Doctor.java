...
public class Doctor extends Nurse
{
	 ...
	 * @param appt the appt
	 * @param pat the pat
	 * @param WorkingNurse the working nurse
	 */
	public void AddDoctorsOrders(String orders, Prescription drugs, LabWork labs, Appointment appt, Patient pat, Nurse WorkingNurse)
	{
		DoctorsOrders docOrder = new DoctorsOrders(this,labs,drugs,orders);
	...
	/**
	 * Checks availability of times and dates of this Doctor object.
